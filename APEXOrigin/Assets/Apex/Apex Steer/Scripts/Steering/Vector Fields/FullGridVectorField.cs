        ...
        private bool GetCellNeighboursAndUnwalkability(Cell cell, DynamicArray<Cell> walkableCells, bool preventDiagonals)
        {
            ...
            for (int x = -1; x <= 1; x++)
            {
                for (int z = -1; z <= 1; z++)
                {
                    ...
                    if (neighbour != null)
                    {
                        if (neighbour.IsWalkable(unitAttributes) && cell.IsWalkableFromWithClearance(neighbour, _unitProperties))
                        {
        ...
        private void GetWalkableCellNeighbours(Cell cell, DynamicArray<Cell> walkableCells, bool preventDiagonals)
        {
            ...
            if (n1 != null)
            {
                ...
                if (!lw)
                {
                    ...
                    if (n1.IsWalkable(unitAttributes) && cell.IsWalkableFromWithClearance(n1, _unitProperties))
                    {
            ...
            if (n2 != null)
            {
                ...
                if (!dw)
                {
                    if (n2.IsWalkable(unitAttributes) && cell.IsWalkableFromWithClearance(n2, _unitProperties))
                    {
            ...
            if (n3 != null)
            {
                ...
                if (!rw)
                {
                    if (n3.IsWalkable(unitAttributes) && cell.IsWalkableFromWithClearance(n3, _unitProperties))
                    {
            ...
            if (n4 != null)
            {
                ...
                if (!uw)
                {
                    if (n4.IsWalkable(unitAttributes) && cell.IsWalkableFromWithClearance(n4, _unitProperties))
                    {
            ...
            if (dlw)
            {
                ...
                {
                    if (n5.IsWalkable(unitAttributes) && cell.IsWalkableFromWithClearance(n5, _unitProperties))
                    {
            ...
            if (ulw)
            {
                ...
                {
                    if (n6.IsWalkable(unitAttributes) && cell.IsWalkableFromWithClearance(n6, _unitProperties))
                    {
            ...
            if (drw)
            {
                ...
                {
                    if (n7.IsWalkable(unitAttributes) && cell.IsWalkableFromWithClearance(n7, _unitProperties))
                    {
            ...
            if (urw)
            {
                ...
                {
                    if (n8.IsWalkable(unitAttributes) && cell.IsWalkableFromWithClearance(n8, _unitProperties))
                    {
